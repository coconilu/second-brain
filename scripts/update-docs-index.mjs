...
const EXTERNAL_DOCS = [
  ...
  {
    title: '理解深度学习 · 交互版',
    url: 'https://coconilu.github.io/understand-dl/',
    tag: '可交互网站',
  ...
  {
    title: '视频流水线 · 交互图解',
    url: 'https://coconilu.github.io/video-pipeline-guide/',
    tag: '可交互网站',
    addedAt: '2026-09-03T00:00:00+08:00',
  },
  {
    title: '127.0.0.1:58628 → myapp.local｜我写了个小工具，把本地服务变成“正经网站”',
    url: 'https://www.bilibili.com/video/BV1JAtv6KE5Y/',
    tag: '视频',
    addedAt: '2026-09-04T00:00:00+08:00',
  },
  {
    title: 'LocalMap — 给本机端口一个像样的域名',
    url: 'https://coconilu.github.io/localmap/',
    tag: '产品主页',
  ...
  {
    title: '还在网页和终端之间来回切？GitGrove 把 GitHub 整条开发链路装进一个桌面应用',
    url: 'https://www.bilibili.com/video/BV1XsbV6eE8B/',
    tag: '视频',
  ...
  {
    title: '从权重到同事：AI 怎么一步步进化成 Agent？本能→模仿→听话→思考→手脚→耐力',
    url: 'https://www.bilibili.com/video/BV1fAh96ZELc/',
    tag: '【视频】',
    addedAt: '2026-09-26T00:00:00+08:00',
  },
];
