...
- [从权重到同事 · 第 1 篇：AI 如何从背书机器变成会想的助手](https://mp.weixin.qq.com/s/Xic8yAmg26zKxv4ZKzZ-oQ) `【公众号】` — 智能体演进录系列：预训练给本能、上下文教模仿、对齐教听话、推理教思考。
- [从权重到同事 · 第 2 篇：长出手脚——工具调用与 Harness 的诞生](https://mp.weixin.qq.com/s/Bo4vWd574h3Wfe8aXAGBHA) `【公众号】` — function calling、ReAct 循环、computer-use 与 MCP/A2A/Skills 协议三件套。
